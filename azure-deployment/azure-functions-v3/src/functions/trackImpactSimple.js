...
app.http('trackImpactSimple', {
    ...
    handler: async (request, context) => {
        ...
        context.log('Simple impact tracking request received');
        ...
        try {
            ...
            if (request.method === 'POST') {
                ...
                context.log('Getting activities for user:', userId);
                const result = await sql.query`
                    SELECT 
                ...
                context.log('Found activities:', result.recordset.length);
            ...
            try {
                ...
                context.log.warn('Error closing database connection:', closeError.message);
            }
        }
    }
});
